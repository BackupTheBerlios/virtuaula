 ...
 */
/**
 * Se encarga de las operaciones sobre los contenedors de datos Areas
 */
public class GestorAreas {
	...
	/**
	 * Me devuelve una lista de areas que cumplen las caracteristicas del area que le paso por parametro
	 * @param bean
	 * @return
	 */
