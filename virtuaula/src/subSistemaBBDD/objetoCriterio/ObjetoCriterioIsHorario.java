 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isHorario.
 * 
 */

public class ObjetoCriterioIsHorario extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsHorario x = new ObjetoCriterioIsHorario();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[6];
		Campos[0] = Constantes.ID_ISHORARIO;
		Campos[1] = Constantes.HORARIO_LUNES;
		Campos[2] = Constantes.HORARIO_MARTES;
		Campos[3] = Constantes.HORARIO_MIERCOLES;
		Campos[4] = Constantes.HORARIO_JUEVES;
		Campos[5] = Constantes.HORARIO_VIERNES;
		
		listaString = new Vector ();		
		listaString.add(Constantes.HORARIO_LUNES);
		listaString.add(Constantes.HORARIO_MARTES);
		listaString.add(Constantes.HORARIO_MIERCOLES);
		listaString.add(Constantes.HORARIO_JUEVES);
		listaString.add(Constantes.HORARIO_VIERNES);
