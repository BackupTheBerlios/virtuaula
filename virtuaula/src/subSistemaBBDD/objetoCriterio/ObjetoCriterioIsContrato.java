 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isContrato.
 * 
 */

public class ObjetoCriterioIsContrato extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsContrato x = new ObjetoCriterioIsContrato();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[3];
		Campos[0] = Constantes.ID_ISCONTRATO_ISUSUARIO_DNI;
		Campos[1] = Constantes.CONTRATO_ISNOMINA_IDISNOMINA;
		Campos[2] = Constantes.CONTRATO_TIPO;
		
		listaString = new Vector ();		
		listaString.add(Constantes.ID_ISCONTRATO_ISUSUARIO_DNI);
		listaString.add(Constantes.CONTRATO_TIPO);
