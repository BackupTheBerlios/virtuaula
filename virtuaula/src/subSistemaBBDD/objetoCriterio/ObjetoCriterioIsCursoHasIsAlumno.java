...
public class ObjetoCriterioIsCursoHasIsAlumno extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsCursoHasIsAlumno x = new ObjetoCriterioIsCursoHasIsAlumno();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[4];
		Campos[0] = Constantes.ID_HAS_ISCURSO_IDISCURSO;
		Campos[1] = Constantes.ID_HAS_ISALUMNO_ISUSUARIO_DNI;
		Campos[2] = Constantes.ISCURSO_HAS_ISALUMNO_ISFICHA_IDISFICHA;
		Campos[3] = Constantes.ISCURSO_HAS_ISALUMNO_NOTA_FINAL;
		
		listaString = new Vector ();		
		listaString.add(Constantes.ID_HAS_ISALUMNO_ISUSUARIO_DNI);
