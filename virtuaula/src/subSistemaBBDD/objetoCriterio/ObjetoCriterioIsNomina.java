 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isNomina.
 * 
 */

public class ObjetoCriterioIsNomina extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsNomina x =  new ObjetoCriterioIsNomina();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[3];
		Campos[0] = Constantes.ID_ISNOMINA;
		Campos[1] = Constantes.NOMINA_CUENTA_INGRESOS;
		Campos[2] = Constantes.NOMINA_CANTIDAD;
		
		listaString = new Vector ();		
		listaString.add(Constantes.NOMINA_CUENTA_INGRESOS);
	}
