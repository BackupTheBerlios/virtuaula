 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isAula.
 * 
 */
public class ObjetoCriterioIsAula extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsAula x = new ObjetoCriterioIsAula();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[4];
		Campos[0] = Constantes.ID_ISAULA;
		Campos[1] = Constantes.AULA_NOMBRE;
		Campos[2] = Constantes.AULA_CAPACIDAD;
		Campos[3] = Constantes.AULA_LOCALIZACION;
		
		listaString = new Vector ();		
		listaString.add(Constantes.AULA_NOMBRE);
		listaString.add(Constantes.AULA_LOCALIZACION);
