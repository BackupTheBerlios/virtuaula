 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isArea.
 * 
 */
public class ObjetoCriterioIsArea extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsArea x = new ObjetoCriterioIsArea();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[2];
		Campos[0] = Constantes.ID_ISAREA;
		Campos[1] = Constantes.AREA_NOMBRE;
		
		listaString = new Vector ();
		listaString.add(Constantes.AREA_NOMBRE);
	}
