 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isUsuario.
 * 
 */
public class ObjetoCriterioIsUsuario extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsUsuario x = new ObjetoCriterioIsUsuario();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[3];
		Campos[0] = Constantes.ID_ISUSUARIO_DNI;
		Campos[1] = Constantes.USUARIO_CONTRASENIA;
		Campos[2] = Constantes.USUARIO_PERFIL;
		
		listaString = new Vector ();		
		listaString.add(Constantes.ID_ISUSUARIO_DNI);
		listaString.add(Constantes.USUARIO_CONTRASENIA);
		listaString.add(Constantes.USUARIO_PERFIL);
	}
