 ...
 * en manejar objetos que definen un criterio de busqueda/consulta en la tabla isHorarioHasIsAula.
 * 
 */

public class ObjetoCriterioIsHorarioHasIsAula extends ObjetoCriterio{
	...
	public ObjetoCriterio clonar(){
		ObjetoCriterioIsHorarioHasIsAula x = new ObjetoCriterioIsHorarioHasIsAula();
		x.inicializar();
		return x;
	}
	...
	public void inicializar(){
		...
		indiceActual = 0;
		Campos = new String[3];
		Campos[0] = Constantes.ID_HAS_ISHORARIO_IDISHORARIO;
		Campos[1] = Constantes.ID_HAS_ISAULA_IDISAULA;
		Campos[2] = Constantes.ISHORARIO_HAS_ISAULA_ISCURSO_IDISCURSO;
