...
<html>
   <head>
      ...
      <title> Buscar Datos de un Alumno Para Modificacion </title>
   ...
   <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
      ...
      <div id="lyComponentes" style="position:absolute; left:0px; top:75px; width:955px; z-index:1; overflow:inherit;">
          ...
          <font face="Trebuchet MS" color="#006699" point-size="5"><b>Buscar alumno</b></font>                
    	   </div>                   			  	 
         <div align="right" style="position:relative; top:-5px">               
    		...
    		<div style="position:relative; left:10px; z-index:-1;">
					<font face="Trebuchet MS" color="#616D7E" point-size="5"><b>Rellene los datos del alumno (paso 1/4)</b></font><br>
    		</div>
    		<div style="position:relative; left:20px; z-index:-1;">
    			<font face="Trebuchet MS" color="#616D7E">
    			   Debe rellenar los datos que conozca del alumno que desea modificar<br>
    			   En caso de no conocer ningún dato, pulse "Buscar" y se mostrarán todos los alumno matriculados en la academia
    			</font>
    		</div>  
