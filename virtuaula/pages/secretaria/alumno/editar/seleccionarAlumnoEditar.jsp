...
<html>
   <head>
      ...
      <title> Seleccionar alumno a modificar </title>
   ...
   <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
      ...
      <div id="lyComponentes" style="position:absolute; left:0px; top:75px; width:955px; z-index:1; overflow:inherit;">
          ...
          <font face="Trebuchet MS" color="#006699" point-size="5"><b>Seleccione el alumno del cual quiere modificar sus datos</b></font>                
    	   </div> 
                  	...
                  	Alumno alumno;
                        ...
                        out.println("	<th class='FormLiteral'><b>Seleccion</th>");
                          ...
                          alumno = (Alumno) listaObjetoBean.dameObjeto(i);
		                    ...
		                    out.println("  <input type='hidden' name='evento' value='SELEC_EDITAR_ALUMNO'>");
		                    ...
		                    out.println(" <button type='submit' class='botonSimple'>Seleccionar</button>");
			                   ...
			                   out.println("<tr>");			 
		      	             out.println("		         <td colspan='7' align='center'> ");
		      	             out.println("			          <input type='hidden' name='evento' value='VUELTA_ALUM2'>");
