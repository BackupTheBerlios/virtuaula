...
<html>
   ...
   <body background="../../../../img/fondo.jpg">
      ...
      <div id="lyComponentes" style="position:absolute; left:0px; top:75px; width:955px; z-index:1; overflow:inherit;">
          ...
          <font face="Trebuchet MS" color="#006699" point-size="5"><b>Modificacion alumno realizada con exito</b></font>                
    	   </div> 
         ...
         <b>            
    		...
    		<div style="position:relative; top:20px; left:80px; z-index:-1;">
    	   	<font face="Trebuchet MS" color="#616D7E" point-size="5"><b>Modificacion realizada con exito.</b></font>  
    	   	  
    			<form method=post action="/virtuaula/ServletVisualizador">
              <table border="0" cellspacing="0" cellpadding="10">
              	<tr>
					         <td colspan="7" align="center">
					          <input type="hidden" name="evento" value="GES_ALUM">
