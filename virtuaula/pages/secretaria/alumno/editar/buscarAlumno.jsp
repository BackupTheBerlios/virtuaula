    		...
    		<div style="position:relative; top:55px; left:80px; z-index:-1;">
              ...
              <table border="0" cellspacing="0" cellpadding="10">
        				<tr>
        					...
        					<td><input type="text" class="FormTxt" maxlength="9" name="ISUSUARIODNI"></td>
        					<td width="100"></td>
        				...
        				<tr>
        					...
        					<td><input type="text" class="FormTxt" maxlength="10" readonly="true" name="FECHNACIMIENTO">&nbsp;&nbsp;<a href="javascript:ggPosX=740;ggPosY=200;show_calendar('consultarAlumno.FECHNACIMIENTO');" onMouseOver="window.status='Seleccione una fecha';  overlib('Pulsa para elegir fecha del mes en el calendario emergente.'); return true;" onMouseOut="window.status=''; nd(); return true;"><img src="../../../../img/show-calendar.gif" width=24 height=22 border=0></a></td>                      
        				</tr>
        				<tr>
