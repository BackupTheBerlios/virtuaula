...
<html>
   <head>
      ...
      <title> Buscar datos de un Alumno </title>
      ...
      <script language=JavaScript type="text/JavaScript">        
          function lanzaFormulario (evento) {
            document.buscarAlumno.evento.value = evento;
            document.buscarAlumno.submit();
          };      
      </script> 
   ...
   <body background="../../../../img/fondo.jpg">
      ...
      <%
                    	    ...
                    	    if (listaCursos != null && !listaCursos.esVacio()) {
                    	    	Curso curso;	
                    	    	out.println("<select name='ISCURSO_IDISCURSO' class='FormTxt'>");
                    	    	...
                    	    	for (int i = 0; i < listaCursos.tamanio(); i++) {
                    	    		curso = (Curso) listaCursos.dameObjeto(i);                    	        
                    	    	        out.println("<option value='"+String.valueOf(curso.dameValor("IDISCURSO"))+"'>"+String.valueOf(curso.dameValor("NOMBRE"))+"</option>");
					
                    	    		
				}
                    	    
                    	    } else {
                    	    	out.println("<font class='FormLiteral'>No hay creado ningún Curso.</font>");
                    	    }  
                  %>      					
        				</td>
              	...
              	<tr>
					         <td colspan="7" align="center">     
					          <input type="hidden" name="idBean" value="consultarAlumno">
						  		 <input type="hidden" name="evento" value="CONS_ALUM2">					         
