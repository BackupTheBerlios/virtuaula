                  	...
                  	Alumno alumno;
                        ...
                        out.println("	<th class='FormLiteral'><b>Seleccion</th>");
        		            ...
        		            out.println("	<th class='FormLiteral'><b>Nombre Alumno</th>");
        		           	out.println("	<th class='FormLiteral'><b>Apellido1</th>");
        		           	out.println("	<th class='FormLiteral'><b>Apellido2</th>");
                          ...
                          alumno = (Alumno) listaObjetoBean.dameObjeto(i);
	                	      ...
	                	      out.println("    <td class='FormLiteral' align='center'>"+String.valueOf(alumno.dameValor("NOMBRE"))+String.valueOf(alumno.dameValor("Apellido1"))+String.valueOf(alumno.dameValor("Apellido2"))+"</td>");
		                    ...
		                    out.println("  <input type='hidden' name='evento' value='MOSTRAR_ALUM'>");
