      ...
      <div id="lyComponentes" style="position:absolute; left:0px; top:75px; width:955px; z-index:1; overflow:inherit;">
         ...
         <div align="right" style="position:relative; top:-5px">               
    		  ...
    		  <div align="right" style="position:relative; z-index:-1;">
                ...
                <a href="JavaScript:lanzaFormulario('GES_CUR');" onmouseout="window.status=''" onmouseover="window.status='Volver al menu de curso';return true ">Volver al menu de curso</a>
    		...
    		<div style="position:relative; left:10px; top:15px; z-index:-1;">
    			<font face="Trebuchet MS" color="#616D7E" point-size="5"><b>Seleccione el curso que desea consultar (paso 2/3)</b>                
    		</div>
    		<div style="position:relative; top:20px; left:175px; z-index:-1;">
