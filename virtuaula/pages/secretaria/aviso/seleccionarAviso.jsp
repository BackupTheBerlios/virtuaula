...
<html>
   <head>
      ...
      <title> Seleccionar Aviso Secretario </title>
                  	...
                  	Avisos aviso;
                        ...
                        out.println("	<th class='FormLiteral'><b>Seleccion</th>");			
                          ...
                          aviso = (Avisos) listaObjetoBean.dameObjeto(i);
		                    ...
		                    out.println("   			        <button onClick=\"JavaScript:lanzaFormularioPrincipal('MOSTRAR_AVISOS_SEC');\" class='botonSimple'>Leer</button>");
		                    out.println("</td>");
		                    out.println("<td>");
