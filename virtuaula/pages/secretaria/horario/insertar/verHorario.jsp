...
<html>
   <head>
      ...
      <title> Datos del Horario Creado</title>
   ...
   <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
      ...
      <div id="lyComponentes" style="position:absolute; left:0px; top:75px; width:955px; z-index:1; overflow:inherit;">
          ...
          <font face="Trebuchet MS" color="#006699" point-size="5"><b>Datos del Horario Creado</b></font>                
    	   </div>                   			  	 
    		...
    		<div style="position:relative; top:10px; left:80px; z-index:-1;">
              ...
              <table border="0" cellspacing="0" cellpadding="10">
                ...
                %>
              	...
              	<tr align="center">
					         <td >
					         	<input type="hidden" name="evento" value="VER_HOR">
