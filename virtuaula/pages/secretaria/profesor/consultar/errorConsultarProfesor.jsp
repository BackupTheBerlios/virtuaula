      ...
      <div id="lyComponentes" style="position:absolute; left:0px; top:75px; width:955px; z-index:1; overflow:inherit;">
         ...
         <div align="right" style="position:relative; top:-5px">               
    		  ...
    		  <div align="right" style="position:relative; z-index:-1;">
                ...
                <a href="JavaScript:lanzaFormulario('menuProfesor');" onmouseout="window.status=''" onmouseover="window.status='Volver al menu profesor';return true ">Volver al menu profesor</a>
    		...
    		<div style="position:relative; top:20px; left:80px; z-index:-1;">
    	   	<font class="error">Error al consultar el profesor especificado.</font>          
    			<form method=post action="/virtuaula/ServletVisualizador">
              <table border="0" cellspacing="0" cellpadding="10">
              	<tr>
					         <td colspan="7" align="center">
					          <input type="hidden" name="evento" value="GES_PROF">
