    			...
    			<form method=post action="/virtuaula/ServletVisualizador" name="formPrincipal">
                    ...
                    ListaObjetoBean listaObjetoBean =((ListaObjetoBean)sesion.getAttribute("listaaviso"));
                  	Avisos aviso;
                        ...
                        out.println("	<th class='FormLiteral'><b>Seleccion</th>");			
                          ...
                          aviso = (Avisos) listaObjetoBean.dameObjeto(i);
		                    ...
		                    out.println("   			        <button onClick=\"JavaScript:lanzaFormularioPrincipal('LEER_AVIS_ALUM');\" class='botonSimple'>Leer</button>");
		                    out.println("</td>");
		                    out.println("<td>");
		                    out.println("   			        <button onClick=\"JavaScript:lanzaFormularioPrincipal('BOR_ALUM_AVIS');\" class='botonSimple'>Borrar</button>");
		                    out.println("</td>");
		                    out.println("<td>");
		              ...
		              <%
		      	             ...
		      	             out.println("			          <input type='hidden' name='evento' value='menuPrincipalAlum'>");
