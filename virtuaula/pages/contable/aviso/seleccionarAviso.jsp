...
<html>
   <head>
      ...
      <title> Seleccionar Aviso Contable </title>
                  	...
                  	Avisos aviso;
                        ...
                        out.println("	<th class='FormLiteral'><b>Seleccion</th>");			
                          ...
                          aviso = (Avisos) listaObjetoBean.dameObjeto(i);
		                    ...
		                    out.println("   			        <button onClick=\"JavaScript:lanzaFormularioPrincipal('MOSTRAR_AVISOS_CONT');\" class='botonSimple'>Leer</button>");
		                    out.println("</td>");
		                    out.println("<td>");
